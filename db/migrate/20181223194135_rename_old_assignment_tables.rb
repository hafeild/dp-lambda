class RenameOldAssignmentTables < ActiveRecord::Migration[5.0]
  def change
    rename_table :assignments, :old_assignemnts
    ...
    rename_table :assignments_software, :old_assignemnts_software
    rename_table :analyses_assignments, :analyses_old_assignments
    rename_table :assignments_datasets, :old_assignemnts_datasets
  end
end
